...
export default function PageAnnonce() {
  return(
    <div className={PageAnnonceStyles.annonce}>
      <div className={PageAnnonceStyles.marche}>
        <div className={PageAnnonceStyles.imageRectangle}><img src="/chaise.jpg"/></div>
        <div className={PageAnnonceStyles.titreAnnonce}> Chaise en bois</div>
        <div className={PageAnnonceStyles.autre}> ébéniste </div>
        <div className={PageAnnonceStyles.otherInfo}>
          <div className={PageAnnonceStyles.autre}> Nantes</div>
          <div className={PageAnnonceStyles.autre}> 12€</div>
        </div>
        <div className={PageAnnonceStyles.description}> Ma chaise en bois adorée a besoin d'un peu d'amour et d'attention, et je recherche un artisan talentueux pour lui redonner son éclat d'antan !
          ✅ Ce que je recherche :
